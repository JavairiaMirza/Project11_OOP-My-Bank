...
class Customer {
    ...
    constructor(name:string,age:number,contactNumber:number,userId:string|number,pin:string|number){
        this.name = name;
        this.age = age;
...
function customerInfo(customer:Customer){
    console.log("--------------------------------------");
...
async function createNewAccount(){
          ...
          var input:Customer  = await inquirer.prompt([
            {
              name: "name",
